...
contract BusdBack is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUSDBACK";
    string constant _symbol = "BUSDBACK";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x874bA57Da02de9a7435E32c3fEa087b14eE698c4;
        devWallet = 0xB976eA8F1a3b5A763148630DB1d274b5f7A1d6Eb;
